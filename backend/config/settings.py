...
# Production hardening is enabled when DEBUG=False. Keep these settings configurable
# because local development and the hackathon demo intentionally use HTTP localhost.
if not DEBUG:
