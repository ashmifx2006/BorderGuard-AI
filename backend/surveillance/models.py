...
class Camera(models.Model):
    ...
    source_path = models.CharField(
        max_length=255,
        blank=True,
        help_text='File path, webcam index, or RTSP URL'
    )
...
class Zone(models.Model):
    ...
    # Polygon stored as JSON list of [x, y] points
...
class DetectionEvent(models.Model):
    ...
    bbox = models.JSONField(
        help_text='[x1, y1, x2, y2] pixel coordinates'
    )
...
class Alert(models.Model):
    ...
    # Event types generated by the AI event-intelligence layer.
    EVENT_CHOICES = [
        (
    ...
    event_score = models.IntegerField(
        default=1,
        help_text='1-10 legacy priority score'
    )

    risk_score = models.IntegerField(
        default=0,
        help_text='0-100 contextual rule-based risk score'
    )
    ...
    correlated_alert_count = models.PositiveIntegerField(
        default=0
    )
    ...
    previous_evidence_hash = models.CharField(
        max_length=64,
        blank=True
    )
